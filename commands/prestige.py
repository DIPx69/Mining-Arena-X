...
async def prestigedone(call):
    ...
    newdata = {'$set':{"coin":0,"minex":0,"xpboost":0,"iron":0,"coal":0,"silver":0,"crimsteel":0,"gold":0,"mythan":0,"magic":0,"lvl":1,"xp":0,"nxtlvlxp":100,"minecooldown":0,"mineon": 0,"autominelvl": 5,"maximum_automine_lvl":5,"potato_seed":0,"broccoli_seed":0,"carrot_seed":0,"corn_seed":0,"watermelon_seed":0,"xpboost_on":0,"minex_on":0}}
    if item == 1:
       name = "Iron"
