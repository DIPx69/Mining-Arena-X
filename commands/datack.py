...
async def datackx(message):
   ...
   await command.save_uid(username,int(idx))
   db = client["user"]
   dataadd = db[idx]
   dataaddx = {"coin":50000,"prestige":0,"prestigecoin":0,"minex":0,"xpboost":0,"iron":0,"coal":0,"silver":0,"crimsteel":0,"gold":0,"mythan":0,"magic":0,"mymine":0,"lvl":1,"xp":0,"nxtlvlxp":100,"dailycooldown":int(time.time()),"minecooldown":0,"warn": 0,"mineon": 0,"automineon": 0,"autominelvl": 2,"itemmulti": 1,"xpmulti": 1,"lvlnoti":0,"ban": 0,"gamecooldown": 0,'streaks': 1,'minexactive': 0,'xpboostactive':0,'mining_item':"none",'xpboost_on':0,'minex_on':0,'end_time': 0,"dice_won":0,"dice_lose":0,"dart_won":0,"dart_lose":0,"basketball_won":0,"basketball_lose":0,"football_won":0,"football_lose":0,"title_list":['Noob'],"active_title":"Noob","maximum_automine_lvl": 2,'potato_seed': 9, 'broccoli': 0, 'broccoli_seed': 9, 'carrot': 0, 'carrot_seed': 0, 'corn': 0, 'corn_seed': 0, 'potato': 0, 'tile_1': 0, 'tile_2': 0, 'tile_3': 0, 'tile_4': 0, 'tile_5': 0, 'tile_6': 0, 'tile_7': 0, 'tile_8': 0, 'tile_9': 0, 'tile_name_1': 'None', 'tile_name_2': 'None', 'tile_name_3': 'None', 'tile_name_4': 'None', 'tile_name_5': 'None', 'tile_name_6': 'None', 'tile_name_7': 'None', 'tile_name_8': 'None', 'tile_name_9': 'None', 'watermelon': 0, 'watermelon_seed': 0, 'water': 15,'sell_all':0,'bank': 0,'max_bank':100000000,'rob_victim_cooldown': 0,'rober_cooldown':0}
